      ...
      <div className="bg-blue-50 p-6 rounded-lg mb-6 border border-blue-200">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <button
            ...
            className="bg-[#0e540b] text-white px-6 py-3 rounded-lg hover:bg-[#063a06] transition-colors font-semibold shadow-md min-w-40 flex items-center justify-center"
          >
