// Updated Navbar.jsx with Authentication
...
const Navbar = () => {
  ...
  const { isAuthenticated, user, logout, setShowAuthModal, loading } = useUserAuth();
  ...
  }, [isAuthenticated, showUserMenu, setShowAuthModal]);
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative user-menu-container">
                <button
                  ...
                  `}
                  aria-label={loading ? 'Loading...' : (isAuthenticated ? 'User menu' : 'Sign in')}
                >
                  {loading ? (
