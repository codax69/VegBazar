...
const CouponCodeSection = ({ 
  ...
  return (
    <div className={`bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl shadow-md border-2 border-dashed border-green-300 ${isMobile ? 'p-3' : 'p-4'}`}>
      {/* Header */}
      ...
      {appliedCoupon ? (
        <div className="bg-white rounded-lg p-3 border-2 border-green-500 shadow-sm">
          ...
          {/* Discount Amount */}
          <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg p-2 flex justify-between items-center">
